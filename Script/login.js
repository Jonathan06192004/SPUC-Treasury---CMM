...
document.getElementById('loginForm').addEventListener('submit', async (e) => {
    ...
    if (!is2FAStep) {
        ...
        if (error || !data) {
            errEl.textContent = 'Access denied. This portal is for CMM users only.';
        ...
        if (data.two_fa_enabled) {
            ...
            sessionStorage.setItem('cmm_user', JSON.stringify(data));
        ...
        try {
            ...
            if (isValid) {
                ...
                sessionStorage.setItem('cmm_user', JSON.stringify(userData));
                location.href = 'Pages/Dashboard.html';
            } else {
